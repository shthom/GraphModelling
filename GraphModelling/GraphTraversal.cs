...
namespace GraphModelling
{
    class GraphTraversal
    {
        ...
        public Tuple<bool, Dictionary<GraphNode<int>, GraphNode<int>>, Dictionary<GraphNode<int>, double>> BellmanFordFunction(Graph<int> g, GraphNode<int> start)
        {
            #region pseudocode
            /*
            ...
            */
            foreach (GraphEdge<int> edge in g.GetEdges())
            {
                ...
                if (distance[toNode] != double.MaxValue && distance[toNode].GT(distance[fromNode] + edge.Distance))
                {
        ...
        public Dictionary<Tuple<GraphNode<int>, GraphNode<int>>, double> FloydWarshallFunction(Graph<int> g)
        {
            #region pseudocode
    ...
    */
        ...
        public Dictionary<Tuple<GraphNode<int>, GraphNode<int>>, double>  JohnsonFunction(Graph<int> g)
        {
            #region pseudocode
            /*
            ...
            */
            ...
            Tuple<bool, Dictionary<GraphNode<int>, GraphNode<int>>, Dictionary<GraphNode<int>, double>> returnVal = BellmanFordFunction(gprime, newNode);
